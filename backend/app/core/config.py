...
class Settings(BaseSettings):
    ...
    # ML spatio-temporal forecast settings
    ml_forecast_enabled: bool = True
    ml_model_path: str = "ml/models/spatiotemporal_model.pkl"
    ml_time_bin_hours: int = 6
    ml_bandwidth_m: float = 450.0
    ml_history_days: int = 30
    ml_region_clusters: int = 4
    ml_neighbor_k: int = 6
    ml_min_risk_threshold: float = 0.01
